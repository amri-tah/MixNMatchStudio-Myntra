...
def main(args):
    ...
    alpha_out_2 = './output/alpha/1.png'
    alpha_out_3 = './output/alpha/2.png'
    ...
    save_transparent_image(downloaded_image_path, [alpha_out_2, alpha_out_3], output_path)

    image_view(downloaded_image_path, alpha_out_3, output_path)
...
if __name__ == '__main__':
    ...
    if not args.image_url:
        args.image_url = "https://myntra-products.s3.amazonaws.com/original/coll8_1.png"
